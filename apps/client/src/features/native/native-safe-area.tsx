...
export function NativeSafeAreaViewport({ children }: PropsWithChildren) {
  return (
    <div className="box-border h-svh min-h-0 w-full overflow-auto bg-background pt-[env(safe-area-inset-top,0px)] pr-[env(safe-area-inset-right,0px)] pb-[env(safe-area-inset-bottom,0px)] pl-[env(safe-area-inset-left,0px)]">
