...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center rounded-sm px-1.5 py-[2px] text-sm font-medium outline-none select-none hover:bg-muted aria-expanded:bg-muted",
        className,
      )}
      {...props}
    />
...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-1.5 rounded-md py-1 pr-1.5 pl-7 text-sm outline-none select-none focus:bg-accent focus:text-accent-foreground [&:focus_*]:text-accent-foreground data-[inset]:pl-7 data-[disabled]:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      checked={checked}
      {...props}
